...
#bg = PhotoImage(file = r"C:\Users\21377\OneDrive - Lynfield College\Documents\2PAD 2024\Pranav Kumar - 91897 and 91896 Assessment\GUIbg.png")

#Show image using label
#label1 = Label( main_window, image = bg)
#label1.place(x = 600, y = 180)
...
def print_customer_details ():
    ...
    Label(main_window, font=("Helvetica 10 bold"),text="Reciept Number").grid(column=0,row=7)
...
def check_inputs ():
    ...
    if len(entry_item.get()) == 0 :
        ...
        input_check = 1
    #Program checks if the item amount is not blank and that the amount enetered is between 5-25 
...
def button_setup():
    ...
    Button(main_window, text="Print Details",command=print_customer_details,width = 12) .grid(column=9,row=0,columnspan=9,rowspan=9,pady=1,sticky=E)
    Button(main_window, text="Delete Row",command=delete_row,width = 10) .grid(column=8,row=7,rowspan=8,columnspan=8,padx=5,sticky=E)
