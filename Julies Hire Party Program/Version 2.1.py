...
def append_name ():
    ...
    customer_details.append([entry_customer_name.get(),item.get(),entry_amount.get()])
    #clear the boxes
...
#myCombo = ttk.Combobox(main_window, value=items)
#myCombo.current(0)
...
def button_setup():
    ...
    Label(main_window, text="Customer Full Name",font=("Bahnschrift" ,12,"bold"),bg='#b4c8e4') .grid(column=0,row=0,sticky=E)
    Label(main_window, text="Item Hired",font=("Bahnschrift" ,12,"bold"),bg='#b4c8e4') .grid(column=0,row=1,sticky=E)
    Button(main_window, text="Quit",font=("Bahnschrift" ,12,"bold"),command=quit,bg="#ba2106",fg = "#FFFFFF",width=12) .grid(column=9, row=0,sticky=E)
    Label(main_window, text="Receipt",font=("Bahnschrift" ,12,"bold"),bg='#b4c8e4') .grid(column=0,row=5,sticky=E)
    Label(main_window, text="Hired Item Quantity",font=("Bahnschrift" ,12,"bold"),bg='#b4c8e4') .grid(column=0,row=2,sticky=E)
    Button(main_window, text="Submit",font=("Bahnschrift" ,12,"bold"),command=check_inputs) .grid(column=9,row=1,pady=10)
    Button(main_window, text="Print Details",font=("Bahnschrift" ,12,"bold"),command=print_customer_details,width = 12) .grid(column=9,row=1,columnspan=9,rowspan=9,pady=6,sticky=E)
    Button(main_window, text="Delete Receipt",font=("Bahnschrift" ,12,"bold"),command=delete_row,width = 12) .grid(column=8,row=7,rowspan=8,columnspan=8,sticky=E)
