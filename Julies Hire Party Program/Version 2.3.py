...
def button_setup():
    ...
    Button(main_window,text="Submit",font=("Bahnschrift", 12, "bold"),command=check_inputs,width=12).grid(column=2,row=1,pady=10,sticky=E)
    ...
    Button(main_window,text="Delete Details",font=("Bahnschrift", 12, "bold"),command=delete_row,width=12).grid(column=3, row=1,pady=10,sticky=E)
