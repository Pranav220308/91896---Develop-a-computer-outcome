...
def saving_details():
    with open("customerdeats.txt","w") as party_details:
        party_details.write(customer_name.get())
        party_details.write(item.get())
        party_details.write(str(entry_amount.get()))
