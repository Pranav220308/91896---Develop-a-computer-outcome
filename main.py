...
bgtest = PhotoImage(file = "Option3.png")
...
def button_setup():
    ...
    Label(main_window, text="Receipt",bg='#b4c8e4') .grid(column=0,row=4,sticky=E)
    ...
    Button(main_window, text="Print Details",command=print_customer_details,width = 12) .grid(column=9,row=2,columnspan=9,rowspan=9,pady=6,sticky=E)
    Label(main_window, text=" ").grid(column=9,row=15,rowspan=15)
    Button(main_window, text="Delete Receipt",command=delete_row,width = 10) .grid(column=9,row=16,rowspan=16,columnspan=8,padx=5,sticky=E)
...
entry_receipt.grid(column=2,columnspan=2,rowspan=13,row=12)
delete_item = Entry(main_window)
delete_item .grid(column=3,row=9,rowspan=9)    
main()
